 ...
 */
public class C4 {
  CombinationMath com = new CombinationMath();
  ...
  public int countKSubsequencesWithMaxBeauty(String s, int k) {
    ...
    if (c >= k) {
      ...
      int len = r - l + 1;
      res = res * com.comb(len, k - l) % mod * com.pow(cnt[k - 1], k - l) % mod;
      return (int) res;
    }
    return 0;
  }
  ...
  class CombinationMath {
    private final int MEMO_THRESHOLD = 2005;
    long mod = 998244353;
